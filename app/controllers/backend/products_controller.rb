class Backend::ProductsController < ApplicationController
  ...
  def destroy
    @product.destroy
    respond_to do |format|
      format.html { redirect_to backend_products_path, notice: 'Product was successfully destroyed.' }
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :price, :image, :lombard_order_id, :bootsy_image_gallery_id)
    end
end
