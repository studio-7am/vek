class LombardOrdersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lombard_order.save
        format.html { redirect_to @lombard_order, notice: 'Lombard order was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to lombard_orders_url, notice: 'Lombard order was successfully destroyed.' }
  ...
  private
    ...
    def lombard_order_params
      params.require(:lombard_order).permit(:number, :slug, :name, :phone, :email, :lombard_id)
    end
end
